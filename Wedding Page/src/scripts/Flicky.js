  ...
  flkty.on('change', function(index) {
    ...
    if(index === 2) {
      if (!hasSlideInOccurred) {
        ...
        rightImageSlide.addEventListener('transitionend', function() {
  ...
  flkty.on('change', function(index) {
    ...
    if(index === 0) {
      if (!hasSlideInOccurreLeft) {
        ...
        leftImageSlide.addEventListener('transitionend', function() {
...
document.addEventListener("DOMContentLoaded", function() {
      ...
      circles.forEach(circle => {
          ...
          if (popup) {
              circle.addEventListener('click', function(e) {
                  ...
                  const allPopups = document.querySelectorAll('.popup-left, .popup-right');
  ...
  setupCirclePopup('.circle-sato', '.popup-left');
  setupCirclePopup('.circle-sato', '.popup-right');
  setupCirclePopup('.circle-mari', '.popup-left');
  setupCirclePopup('.circle-mari', '.popup-right');
});
